...
public class BenchmarkRunner {
    ...
    private static final double SEARCH_DENSITY = 0.3; // constant search density

    public static void main(String[] args) throws Exception {
        int[] gridSizes = {50, 100, 150, 200, 250, 300, 400, 500,600,700,1000}; // different dungeon sizes
        int seed = 60; 
